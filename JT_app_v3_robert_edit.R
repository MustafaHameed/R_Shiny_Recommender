...
ui <- shinyUI(fluidPage(
  ...
  ###################  CSS   ###################  
    ...
    tags$style(type="text/css", "footer{
      ...
      z-index: 1000;}"),
    tags$style(type="text/css", "#table th {display: none;}"), 
    tags$style(type="text/css", "#profileTable th {display: none;}") 
...
# the method selected by the user
  ...
  output$table <- renderTable({
    ...
    ############################################
      ...
      arecs <- sort(art_sim[(a_val), ], decreasing = TRUE)[1:n_recommended]
